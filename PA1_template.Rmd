...
Missing values are filled in with mean value for that 5-minute
interval.

```{r}
# Each missing value is replaced with the mean value of its 5-minute interval
...
The dataset with the filled-in missing values is being used.
...
Following is a panel plot containing plots of average number of steps taken on weekdays and weekends.
